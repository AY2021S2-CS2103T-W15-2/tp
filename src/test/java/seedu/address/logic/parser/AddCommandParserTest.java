...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND).withRemark(VALID_REMARK_HANDSOME)
                .build();
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withRemark(VALID_REMARK_HANDSOME)
